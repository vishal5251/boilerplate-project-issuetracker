...
module.exports = function (app) {
  ...
  app.route('/api/issues/:project')
    ...
    .get(function (req, res) {
      ...
      const { _id, open, issue_text, issue_title, created_by, assigned_to, status_text, } = req.query;
    ...
    .put(function (req, res) {
      let projectName = req.params.project;
      const { _id, open, issue_text, issue_title, created_by, assigned_to, status_text, } = req.body;
